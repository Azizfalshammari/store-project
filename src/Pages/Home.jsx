        ...
        <Nav/>
          ...
          <div className='home flex justify-items-center'>
              ...
              <div className="text text-[#fff]">
                  ...
                  <p className='text-[14px]'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Velit temporibus aperiam obcaecati qui rerum incidunt, saepe, dignissimos laudantium explicabo ea perspiciatis, aut sunt odit quos ab consectetur maxime molestiae optio?</p>
              </div>
              {/* right */}
              <div>
          ...
          <div className="sectionTwo div flex mb-[40px]">
              ...
              <div className='bg-[#eee] mr-[10px]'>
                <h4 className="Title bg-[#fff] text-[gray] w-[100px] mt-[5px] ml-[5px]">Electronics</h4>
                <img className='h-[400px] w-[180px] mr-[10px] rounded-[6px] m-[auto]' src="https://m.media-amazon.com/images/I/71yzJoE7WlL._AC_SX679_.jpg" alt="" />
              </div>
            {/* right box */}
              <div>
                  <div className="flex">
                      ...
                      <div className=''>
                      <img className='w-[250px] h-[180px]   mb-[10px] mt-[-10px] rounded-[6px] m-[auto]' src={img2} alt="" />
                      </div>
                  ...
                  <div>
                    <h4 className="Title">Title</h4>
                    <div className="">
                    <img className='h-[190px] w-[800px] mb-[10px] rounded-[6px]' src="https://img.paisawapas.com/ovz3vew9pw/2021/10/06223906/amazon-trending.jpg" alt="" />
                    </div>
          ...
          <div className="sectionThree">
            <div className='box flex p-[10px] bg-[#fff] '>
                {element.map((el)=> {
                    return <div className='content' key={el.id}>
