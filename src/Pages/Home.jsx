        ...
        <Nav/>
          ...
          <div className='home flex justify-items-center'>
              ...
              <div className="text text-[#fff]">
                  <h1 className='text-[35px] mb-[10px]'>Explore the world of technology with us</h1>
                  <p className='text-[14px]'>Welcome to our electronics store, where we offer the latest technologies and electronic devices to meet all your technological needs. We take pride in providing a wide range of products including smartphones, laptops, tablets, and premium accessories that combine superior performance with stylish design.</p>
              </div>
              {/* right */}
              <div>
          ...
          <div className="sectionTwo div flex mb-[40px] ">
              ...
              <div className='bg-[#a4c3b2] mr-[10px]'>
                <h4 className="Title bg-[#a4c3b2] text-[gray] w-[100px] mt-[5px] ml-[5px]">Smartphone</h4>
                <img className='h-[400px] w-[200px] mr-[10px] rounded-[6px] m-[auto] bg-[#a4c3b2]' src={img3} alt="" />
              </div>
            {/* right box */}
              <div>
                  <div className="flex">
                      ...
                      <div className=''>
                      <img className='w-[250px] h-[180px]   mb-[10px] mt-[-5px] rounded-[6px] m-[auto]' src={img2} alt="" />
                      </div>
